...
//				Delay = inOut.Hours*60+inOut.Minutes;
				...
				{
                    timeOut =DateTime.Parse(TimeIn);
					timeIn = DateTime.Parse(TimeInOut);	
//					string test = timeOut.Hour+ ": "+timeOut.Minute;
//					test+ = timeIn.Hour+ ": "+timeIn.Minute;
				...
				else if(Delay >= 5)// giua 2 lan quet the cach nhau 15 min moi luu vao database
				{
