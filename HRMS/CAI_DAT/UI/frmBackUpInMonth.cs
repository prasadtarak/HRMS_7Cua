...
{
	/// <summary>
	/// Summary description for frmBackUpInMonth.
	/// </summary>
	public class frmBackUpInMonth : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frmBackUpInMonth";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Ch?n kho?ng th?i gian sao lýu d? li?u";
		...
		{
			this.Text = WorkingContext.LangManager.GetString("frmChooseBackupData_Text");
			...
			this.btnDisplay.Text = WorkingContext.LangManager.GetString("frmLunch_btnSaoChep");
